        ...
        <tbody>
            @forelse ($all_posts as $post)
                <tr>
                    <td>{{ $post->id}}</td>
                    <td>
                        <a href="{{ route('post.show', $post->id)}}"><img src="{{$post->image}}" alt="Post ID {{ $post->id}}" class="d-block mx-auto image-lg"></a>
                    </td>
                    <td>
                    ...
                    <td>
                        @if ($post->trashed())
                            <i class="fa-regular fa-circle-minus text-secondary"></i>&nbsp; Hidden
                        @else
